...
_magic_number = 10
_modified_time = 1466013200.4839654
_enable_loop = True
_template_filename = '/usr/lib/python3.5/site-packages/nikola/data/themes/bootstrap3/templates/base_helper.tmpl'
_template_uri = 'base_helper.tmpl'
_source_encoding = 'utf-8'
_exports = ['late_load_js', 'html_feedlinks', 'html_navigation_links', 'html_headstart', 'html_translations', 'html_stylesheets']
